namespace FewClicksDev.Core
{
    ...
    {
        // UNITY
        private static Texture2D popupIcon = null;
        private static Texture2D errorIcon = null;
        private static Texture2D warningIcon = null;
        private static Texture2D toolbarMinusIcon = null;

        public static Texture2D Popup => findAndReturnEditorIcon(ref popupIcon, "_Popup");
        public static Texture2D Error => findAndReturnEditorIcon(ref errorIcon, "console.erroricon.sml");
        public static Texture2D Warning => findAndReturnEditorIcon(ref warningIcon, "console.warnicon.sml");
        public static Texture2D ToolbarMinus => findAndReturnEditorIcon(ref toolbarMinusIcon, "Toolbar Minus");
        ...
        private static Texture2D leaveReviewBackground = null;
        ...
        private static Texture2D inspectOutBackground = null;
        private static Texture2D inspectOutActiveBackground = null;
        ...
        private static Texture2D arrowUpBackground = null;
        private static Texture2D arrowUpActiveBackground = null;
        private static Texture2D arrowDownBackground = null;
        private static Texture2D arrowDownActiveBackground = null;
        ...
        public static Texture2D LeaveReviewBackground => findAndReturnIcon(ref leaveReviewBackground, "sp_LeaveReview");
        ...
        public static Texture2D InspectOutBackground => findAndReturnIcon(ref inspectOutBackground, "sp_Inspect_Out");
        public static Texture2D InspectOutActiveBackground => findAndReturnIcon(ref inspectOutActiveBackground, "sp_Inspect_Out_Active");
        ...
        public static Texture2D ArrowUpBackground => findAndReturnIcon(ref arrowUpBackground, "sp_ArrowUp");
        public static Texture2D ArrowUpActiveBackground => findAndReturnIcon(ref arrowUpActiveBackground, "sp_ArrowUp_Active");
        public static Texture2D ArrowDownBackground => findAndReturnIcon(ref arrowDownBackground, "sp_ArrowDown");
        public static Texture2D ArrowDownActiveBackground => findAndReturnIcon(ref arrowDownActiveBackground, "sp_ArrowDown_Active");
        ...
        private static Texture2D findAndReturnEditorIcon(ref Texture2D _icon, string _textureName) 
        {
            if (_icon == null)
            {
                _icon = EditorGUIUtility.FindTexture(_textureName);
            }
