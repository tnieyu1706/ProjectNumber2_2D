...
namespace TnieCustomPackage.SerializeInterface
{
	...
	[System.Serializable]
	public class InterfaceReferenceGUIProp<TInterface, UObject> where UObject : Object where TInterface : class
	{
		[SerializeField]
		[HideInInspector]
		...
		public InterfaceReferenceGUIProp() { }
		public InterfaceReferenceGUIProp(UObject target) => _underlyingValue = target;
		public InterfaceReferenceGUIProp(TInterface @interface) => _underlyingValue = @interface as UObject;

		public static implicit operator TInterface(InterfaceReferenceGUIProp<TInterface, UObject> obj) => obj.Value;
	}
	...
	/// <typeparam name="TInterface">The interface.</typeparam>
	[System.Serializable]
	public class InterfaceReferenceGUIProp<TInterface> : InterfaceReferenceGUIProp<TInterface, Object> where TInterface : class
	{
	}
}