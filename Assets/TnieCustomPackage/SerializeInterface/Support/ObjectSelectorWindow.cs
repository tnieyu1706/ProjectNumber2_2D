...
using Tab = TnieCustomPackage.SerializeInterface.Support.UIElements.Tab;
using Toggle = UnityEngine.UIElements.Toggle;
using ToggleGroup = TnieCustomPackage.SerializeInterface.Support.UIElements.ToggleGroup;

namespace TnieCustomPackage.SerializeInterface.Support
{
    internal class ObjectSelectorWindow : EditorWindow
    {
        private const string STYLESHEET_PATH =
            "Assets/TnieCustomPackage/SerializeInterface/Support/USS/ObjectSelectorWindow.uss";
